...
class Visualizer:
    ...
    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE):
        ...
        self._default_font_size = max(
            np.sqrt(self.output.height * self.output.width) // 100, 10 // scale
        )
        self._instance_mode = instance_mode


    def draw_instance_predictions_cam(self, predictions, image_name=None):
        """
    ...
    def overlay_instances(
        ...
        *,
        ...
        # 简单统计label
        label_dict = {}
        for label_ele in labels:
            label_ele = label_ele.split(' ')[0]
            if label_ele in label_dict:
                tmp = label_dict[label_ele]
                tmp = tmp + 1
                label_dict[label_ele] = tmp
                pass

            else:
                label_dict[label_ele] = 1
                pass
            pass
    ...
    def draw_text(
        ...
        *,
        ...
        # print('fontSize:' + str(font_size * self.output.scale))
